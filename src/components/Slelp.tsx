...
export default class Slelp extends Component {
  render() {
    return (
      <div className='project slelp-project'>
        <div className='fond'>
        ...
        <div className='card'>
          ...
          <div className='right-half'>
            <div className='right'>
              ...
              <p>
                Slelp is an app that provides a team quick and easy access to find answered questions, answer questions, and to request help
                on specific issues.
              </p>
            </div>
