...
export default class HealthAlarm extends Component {
  ...
  render() {
    return (<div className="project healthAlarm-project">
      <div className="fond">
      ...
      <div className="card">
        ...
        <div className="right-half">
          <div className="right">
            ...
            <p>HealthAlarm is an alarm clock that wakes you up with a game plan for how to start your day. Using Google Home and Google Assistant via Dialogflow API so you can have a conversation to better understand where you are on your personal goals, and health data. This is the React Native UI that prompts access for your Apple Health Data to store in a API that Dialogflow API then communicates with to give you accurate speech responses straight from your Google Home</p>
          </div>
